  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="container">
      <div class="row mt-4">
        <!-- Main Area Start-->
        <div class="col-sm-8 ">
          <h1>Welcome to Opiner Daniel blog </h1>
          <h1 class="lead">Get the leatest gist in tech</h1>
          <?php
           echo ErrorMessage();
           echo SuccessMessage();
           ?>
      ...
      <div class="container">
        <div class="row">
          ...
          <p class="text-center small"><a style="color: white; text-decoration: none; cursor: pointer;" href="http://opinerdaniel.com.ng/coupons/" target="_blank"> This site is only used
           for Study purpose opinerdaniel.com.ng have all the rights. no one is allow to distribute copies other then <br>&trade; opinerdaniel.com.ng &trade;  </a></p
           </div>
         </div>
      </div>
    </footer>

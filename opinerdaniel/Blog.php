    ...
    <div class="container">
      <div class="row mt-4">
        ...
        <div class="col-sm-8 ">
          ...
          <h1 class="lead">Get the leatest gist on technology related programs around the world</h1>
          <?php
           echo ErrorMessage();
           echo SuccessMessage();
           ?>
    ...
    <footer class="bg-dark text-white">
      <div class="container">
        <div class="row">
          ...
          <p class="text-center small"><a style="color: white; text-decoration: none; cursor: pointer;" href="http://opinerdaniel.com.ng/coupons/" target="_blank"> This site is only used for Study purpose opinerdaniel.com.ng have all the rights. no one is allow to distribute copies other then studies <br>&trade;opinerdaniel.com.ng</a></p>
           </div>
         </div>
      </div>
    </footer>

    ...
    <footer class="bg-dark text-white">
      <div class="container">
        <div class="row">
          ...
          <p class="text-center small"><a style="color: white; text-decoration: none; cursor: pointer;" href="http://opinerdaniel.com.ng/coupons/" target="_blank"> This site is only used for Study purpose opinerdanie.com.ng have all the rights. no one is allow to distribute copies other then <br>&trade; opinerdaniel.com.ng &trade; </a></p>
           </div>
         </div>
      </div>
    </footer>
